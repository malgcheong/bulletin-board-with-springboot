...
public enum CommonErrorCode {
    ...
    COMMENT_UNAUTHORIZED(Status.FAIL.name(), HttpStatus.UNAUTHORIZED, "User is not authorized to access this resource"),
    ...
    COMMENT_NOT_FOUND(Status.FAIL.name(), HttpStatus.NOT_FOUND, "Comment not found with id"),
